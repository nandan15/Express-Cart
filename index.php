...
<html lang="en">
	<head>
	    ...
	    <title>Express-Cart Home Page</title>
    ...
    <body class="cnt-home" bgcolor="red">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(img/aa72abca784117244de372b5e9926988-online-shopping-slider-template.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(img/homepage-banner-1.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Men Wear</a></li>
					<li><a href="#furniture" data-toggle="tab">Men Footwear</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Men's Wear</h3>
